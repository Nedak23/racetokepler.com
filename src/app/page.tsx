      ...
      <main className="relative z-10 min-h-screen">
        ...
        <div className="container mx-auto px-4 pt-24 pb-20">
          <div className="text-center max-w-2xl mx-auto">            
            ...
            <p className="text-lg text-orange-400 mb-4">Coming in 2025</p>
        ...
        <div className="flex justify-center items-center gap-4 text-orange-400/60 py-4">
        ...
        <div className="container mx-auto px-4 py-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-black/40 backdrop-blur-sm p-8 rounded-lg border border-emerald-900/30">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">High Player Interaction</h3>
              <p className="text-gray-300">
            ...
            <div className="bg-black/40 backdrop-blur-sm p-8 rounded-lg border border-emerald-900/30">
              ...
              <p className="text-gray-300">
                Create variance from game to game with new puzzles to work through with different City cards.
              </p>
            </div>
          </div>
        </div>
